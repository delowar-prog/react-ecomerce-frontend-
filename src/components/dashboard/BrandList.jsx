...
const BrandList = ({ setActiveContent, updateBrand, setUpdateBrand }) => {
                                ...
                                >
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <button className='black' onClick={() => handleUpdate(item)}><FaEdit size={24} /> </button>
                                        </div>
                                    </>
